        ...
        <div className="flex justify-between pt-2">
            ...
            <div className="flex flex-wrap gap-4 w-[55%]" >
                {skills.map((skill,index) => (
                    <div className="border-[1px] font-family skill-hover transition-all duration-500 ease-in-out hover:transition-all hover:duration-500 hover:ease-in-out  w-[30%] h-[100px]" key={index} >
